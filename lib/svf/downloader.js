...
const forge_server_utils_sitelink_1 = require("forge-server-utils-sitelink");
const __1 = require("..");
class Downloader {
    constructor(auth, host, region) {
        this.auth = auth;
        this.modelDerivativeClient = new forge_server_utils_sitelink_1.ModelDerivativeClient(this.auth, host, region);
    }
    ...
    async _download(urn, context) {
        ...
        const helper = new forge_server_utils_sitelink_1.ManifestHelper(await this.modelDerivativeClient.getManifest(urn));
